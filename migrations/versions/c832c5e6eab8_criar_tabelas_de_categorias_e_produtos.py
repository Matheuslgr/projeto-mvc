...
Revision ID: c832c5e6eab8
Revises: 46f035432315
Create Date: 2026-05-29 10:31:08.268284
...
revision: str = 'c832c5e6eab8'
down_revision: Union[str, Sequence[str], None] = '46f035432315'
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['categoria_id'], ['categorias.id'], onupdate='SET NULL'),
    sa.PrimaryKeyConstraint('id')
    )
